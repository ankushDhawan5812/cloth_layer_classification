...
# Example usage
layer_str = 'two_layers_2'
wrench_dir = f'test_data/wrench_data/{layer_str}'
input_dir = f'test_data/output_videos/{layer_str}'
output_dir = f'output_tests_data_5_23/video_data/{layer_str}'
